...
type Errors interface {
	Error40x(c *core.Context, msg string)
	Error50x(c *core.Context, msg string)
	Recover(c *core.Context) func()
}
...
func (e *ErrHandler) Error40x(c *core.Context, msg string) {
	_, _ = c.Writer().Write([]byte(msg))
}

func (e *ErrHandler) Error50x(c *core.Context, msg string) {
	_, _ = c.Writer().Write([]byte(msg))
}
